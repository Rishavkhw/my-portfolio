    ...
    <section className="min-h-screen flex items-center section-padding pt-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="max-w-3xl">
          ...
          >
            Rishav <span className="text-gradient">Khatiwada</span>
          </h1>
          <p
            className="text-xl md:text-2xl text-muted-foreground font-heading font-medium mb-6 animate-fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
            IT Professional · Frontend Developer · Networking Enthusiast
          </p>
          <p
            className="text-muted-foreground max-w-xl mb-8 leading-relaxed animate-fade-in-up"
            style={{ animationDelay: "0.3s" }}
          >
            Building modern web systems and solving technical problems — from
            responsive UIs to networking infrastructure. BSc CSIT student with
            real-world experience across ISP ops, public-sector IT, and frontend
            development.
          </p>
          ...
          >
            ...
            <a
              href="/RishavKhatiwada_CV.pdf"
              download="RishavKhatiwada_CV.pdf"
          ...
          >
            <a
              href="https://github.com/Rishavkhw"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/rishavkhatiwada21/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary transition-colors"
            >
